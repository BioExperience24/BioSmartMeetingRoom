...
public class RoomViewModelAlt : BaseLongViewModel
{
    [JsonPropertyName("radid")]
    public string Radid { get; set; } = string.Empty;
...
public class RoomVMFindAvailable
{
    [FromQuery(Name = "book_filter_room_category")]
    ...
    [FromQuery(Name = "book_filter_time_from")]
    public string TimeFrom { get; set; } = string.Empty;

    [FromQuery(Name = "book_filter_time_until")]
    public string TimeUntil { get; set; } = string.Empty;

    [FromQuery(Name = "book_filter_time_allday")]
    public string IsAllDay { get; set; } = string.Empty;

    [FromQuery(Name = "book_filter_cap_facilities[]")]
    public long[]? FacilityRoom { get; set; }
...
{
    [BindProperty(Name = "building_search")]
    public string? BuildingSearch { get; set; }

    [BindProperty(Name = "room_search")]
    public string? RoomSearch { get; set; }

    [BindProperty(Name = "date1_search")]
    public string? Date1Search { get; set; }

    [BindProperty(Name = "date2_search")]
    public string? Date2Search { get; set; }

    [BindProperty(Name = "gmt")]
    public string? Gmt { get; set; }

    [BindProperty(Name = "department_search")]
