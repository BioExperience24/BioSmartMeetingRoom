...
public class BaseLongUowRepository<E> where E : BaseLongEntity, new()
{
    ...
    public BaseLongUowRepository(IUnitOfWork uow)
    {
        _uowo = uow;
    ...
    public virtual async Task<E?> GetById(long id, bool isTracking = false)
    {
